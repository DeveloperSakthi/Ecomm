...
const Admin = () => {
  ...
  const allowedAdminEmails = [ 'sakthivelr.developer@gmail.com', 'example@gmail.com']; // List of admin-approved emails
            ...
            <ul className="admin-order-list">
              {orders.map(order => (
                <li key={order._id} className="admin-order-item">
                  ...
                  <p>
                    <strong>Paid:</strong>{' '}
                    {order.isPaid ? `Yes (at ${new Date(order.paidAt).toLocaleString()})` : 'Yes'}
                  </p>
                  <div>
                    <strong>Items:</strong>
                    <ul>
